...
class SearchExecutionModel(Base):
    ...
    jobs_fresher_eligible: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    recommendations_created: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
